...
export default function App() {
    ...
    // New: Store specifically which item to try on (whether from canvas or direct list)
    ...
    // Fallback: If opening via general button, use selected item or last item
    const getAIItem = () => {
        ...
        <div className="flex flex-col h-screen font-sans">
            ...
            <main className="flex-1 flex flex-col md:flex-row overflow-hidden">
                <Sidebar
                    ...
                    onDirectTryOn={handleDirectTryOn} // Pass the new handler
                    onOpenAI={() => {
                        if(!baseImage) return alert("Upload a photo first");
                        // If generic button clicked, reset active item so it falls back to canvas selection
